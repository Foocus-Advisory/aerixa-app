        ...
        <main className="w-full space-y-5 px-3 py-4 pb-24 md:space-y-6 md:px-8 md:py-8 md:pb-8">
          <Breadcrumbs
            items={[
              ...
              { label: locale === "fr" ? "Niveaux par filière" : "Program track levels" },
            ]}
          />
          ...
          <div className="grid gap-6">
            ...
            <Card className="border-border/60 bg-card/70">
              ...
              <CardContent>
                {effectiveEstId ? (
                  <ProgramTrackLevelsSection accessToken={accessToken} locale={locale} establishmentId={effectiveEstId} />
                ) : (
