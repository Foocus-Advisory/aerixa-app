        ...
        <main className="w-full space-y-5 px-3 py-4 pb-24 md:space-y-6 md:px-8 md:py-8 md:pb-8">
          ...
          <div className="grid gap-6">
            <Card className="border-border/60 bg-card/70 shadow-sm">
              <CardHeader className="flex flex-col gap-1 md:flex-row md:items-center md:justify-between">
                ...
                <Badge className="w-fit" variant="outline">
                  ...
                  {locale === "fr" ? "Section : Niveaux académiques" : "Section: Academic levels"}
                </Badge>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border/60 bg-card/70">
              ...
              <CardContent>
                {effectiveEstId ? (
                  <AcademicLevelsSection accessToken={accessToken} locale={locale} establishmentId={effectiveEstId} />
                ) : (
