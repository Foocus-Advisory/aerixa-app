...
const EMPTY_MAPPING: Record<ImportFieldKey, string> = { name: "", type: "", code: "", active: "" };
                        ...
                        items={[
                          {
                            ...
                            icon: ArrowRight,
                            onClick: () => router.push(`/dashboard/acquisition-channels/${item.id}?establishmentId=${establishmentId}`),
                          },
                          {
                            label: t.tooltipView,
                            icon: Eye,
